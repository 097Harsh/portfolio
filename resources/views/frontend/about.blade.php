            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="position-relative">
                        <img src="frontend/images/myphoto1.jpg" alt="" class="radius-image img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 mt-lg-0 mt-5">
                    <h5 class="title-small mb-2">Hello, I am UI/UX Designer</h5>
                    <h3 class="title-big">Having O7 Years of Experience</h3>
                    <p class="mt-4"> including visual UI/UX design and web development, is a significant milestone that typically signifies a wealth of knowledge, skills, and a deep understanding of the industry. </p>
...
<div class="abouthy-img-grids">
    <div class="img-one">
        <img src="frontend/images/g5.jpg" alt=" " class="img-fluid">
    </div>
    ...
    <div class="img-one">
        <img src="frontend/images/g3.jpg" alt=" " class="img-fluid">
    </div>
</div>
<!-- //subscribe block -->
