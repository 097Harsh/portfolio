        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-sm-12 mt-lg-0 mt-4">
                ...
                <div class="mt-sm-5 mt-4">
                    <a class="btn btn-primary btn-style mr-2" href="{{url('')}}/contact"> Hire Me </a>
                    <a class="btn btn-outline-primary btn-style mr-2" href="{{url('/')}}"> Portfolio </a>
                </div>
            </div>
            <div class="col-lg-6 col-md-8 col-sm-10 mt-lg-0 mt-4">
                <div class="img-effect text-lg-center">
                    <img src="frontend/images/photo.png" alt="myphoto" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="position-relative">
                        <img src="frontend/images/myphoto.jpg" alt="" class="radius-image img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 mt-lg-0 mt-5">
                    ...
                    <p class="mt-4">Hello Alexander Smith! As a visual UI/UX designer and web developer, you are someone who specializes in creating engaging and user-friendly interfaces for websites and applications. Your role involves combining design principles with technical skills to enhance the overall user experience!</p>
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="box-wrap">
                                    ...
                                    <h4><a href="#url">Database Architecture</a></h4>
                                    <p>Lorem ipsum dolor sit amet sed consectetur adipisicing elit.
                                        doloret quas saepe autem, dolor set.</p>
                                    <a href="#read" class="read">Read more</a>
                                </div>
                        ...
                        <div class="item">
                            <div class="card">
                                <div class="box-wrap">
                                    ...
                                    <h4><a href="#url">Business Analysis</a></h4>
                                    <p>Lorem ipsum dolor sit amet sed consectetur adipisicing elit.
                                      doloret quas saepe autem, dolor set.</p>
                                      <a href="#read" class="read">Read more</a>
                                  </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="frontend/images/team1.jpg" class="img-fluid" alt="client-img">
                                    </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="frontend/images/team2.jpg" class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Julia sakura</h3>
                                        <p class="indentity">Seattle, Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="frontend/images/team3.jpg" class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Roy Linderson</h3>
                                        <p class="indentity">Seattle, Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="frontend/images/team4.jpg" class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Mike Thyson</h3>
                                        <p class="indentity">Seattle, Washington</p>
        ...
        <div class="container py-lg-5">
            <div class="middle-section text-center">
                ...
                <div class="history-info mt-5">
                    <div class="position-relative">
                        <img src="frontend/images/bg.jpg" class="img-fluid radius-image video-popup-image"
                            alt="video-popup">
...
<!-- //home page video popup section -->
 ...
 <section class="w3l-grid-quote text-center py-5">
   <div class="container py-3">
     ...
     <a href="{{url('')}}/contact" class="btn btn-style btn-primary mr-2">Hire Me </a>
     <a href="{{url('')}}/contact" class="btn btn-style btn-outline-primary">Get in touch</a>
   </div>
 </section>
 <!-- //freelance hire me -->
